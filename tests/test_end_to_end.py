...
def make_reporter(cost_estimate):
    """Helper to create a CostReportGenerator from a cost estimate."""
    return CostReportGenerator(cost_estimate)
...
class TestEndToEndPipeline:
    ...
    def test_complete_pipeline_arduino_shield(self, parser, estimator):
        ...
        reporter = make_reporter(cost_estimate)
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert 'itemized_components' in json_data
    ...
    def test_complete_pipeline_iot_board(self, parser, estimator):
        ...
        reporter = make_reporter(cost_estimate)
        # generate_cli_table prints to console; just ensure it doesn't crash
...
class TestReportFormatValidation:
    ...
    def test_json_report_valid(self, sample_estimate):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert 'cost_per_board' in data['executive_summary']
            assert isinstance(data['executive_summary']['cost_per_board']['typical'], (int, float))
